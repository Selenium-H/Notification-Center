...
const Prefs1 =  new GObject.Class({
  ...
  _init: function(page)
  {
    ...
    switch (page) {
        case 1 :
          this.prefSwitch(_('Show Media Section on Notification Center'), "show-media", 0, settings);
        ...
        case 2:
          ...
          this.prefStr(_('Shortcut key combiation to show indicator'), 'indicator-shortcut', 2, ['<Alt>', '<Ctrl>', '<Shift>', '<Super>'], [_('Alt Key'), _('Ctrl Key'), _('Shift Key'), _('Super Key')], settings);
          this.prefCombo(_('When new notification arrives'),'new-notification', 3, ['none', 'dot', 'count'], [_('Show Nothing'), _('Show Dot'), _('Show Count')], settings);
          ...
          this.prefSwitch(_('Middle click panel icon to toggle Do Not Disturb mode' ) ,'middle-click-dnd'  ,7 ,settings);
        default:
          break;
    }
    return this.grid;
